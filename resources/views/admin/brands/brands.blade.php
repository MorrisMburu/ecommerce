...
<div class="x_panel">
	<div class="row">
		<h2>Brands</h2>
		<button class="btn bg-transparent" style="margin-left: auto"><a href="{{url('admin/add-edit-brand')}}" >Add Brand</a></button>
	</div>
	<div class="row">
		<div class="col-sm-12">
								...
								<tbody>
									...
									<tr role="row" class="odd">
										...
										<td>
											...
											@else
											<a class="updateBrandStatus" id="brand-{{$brand->id}}" brand_id="{{$brand->id}}" href="javascript:void(0)"><i class="fa fa-toggle-off" status="Inactive"></i></a>
											@endif
											&nbsp;&nbsp;&nbsp;
											<a title="edit" href="{{url('admin/add-edit-brand/'. $brand->id)}}"><i class="fa fa-edit"></i></a>&nbsp;
											<a title="delete" class="confirmDelete" href="javascript:void(0)" record="brand" recordid="{{$brand->id}}" <?php /* href="{{url('admin/delete-brand/'. $brand->id)}}"*/ ?> ><i class="fa fa-trash"></i></a>
										</td>
									</tr>
									@endforeach
								</tbody>
