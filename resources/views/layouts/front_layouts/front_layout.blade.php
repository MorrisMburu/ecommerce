...
<head>
	...
	<!-- Front style -->
	<link id="callCss" rel="stylesheet" href="{{ url('/assets/css/front_css/front.min.css')}}" media="screen"/>
	<link href="{{ url('/assets/css/front_css/base.css')}}" rel="stylesheet" media="screen"/>
	<!-- Front style responsive -->
	<link href="{{ url('/assets/css/front_css/front-responsive.min.css')}}" rel="stylesheet"/>
	<link href="{{ url('/assets/css/front_css/font-awesome.css')}}" rel="stylesheet" type="text/css">
	<!-- Google-code-prettify -->
	<link href="{{ url('/assets/js/front_js/google-code-prettify/prettify.css')}}" rel="stylesheet"/>
	<!-- fav and touch icons -->
...
<body>
	...
	<script src="{{ url('/assets/js/front_js/jquery.js')}}" type="text/javascript"></script>
	<script src="{{ url('/assets/js/front_js/front.min.js')}}" type="text/javascript"></script>
	<script src="{{ url('/assets/js/front_js/google-code-prettify/prettify.js')}}"></script>

	<script src="{{ url('/assets/js/front_js/front.js')}}"></script>
	<script src="{{ url('/assets/js/front_js/jquery.lightbox-0.5.js')}}"></script>
